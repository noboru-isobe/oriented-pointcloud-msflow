...
<table>
<tr>
  <th align="center">Two ellipses merging</th>
  <th align="center">Flower rounding</th>
</tr>
<tr>
<td><img src="results/two_ellipses_boundary.gif" alt="Two ellipses merging under MS flow" width="100%"></td>
<td><img src="results/flower_boundary.gif" alt="Flower rounding under MS flow" width="100%"></td>
</tr>
</table>
...
- **Grid-free**: computed from boundary points only — no phase field.
...
Boundary points coloured by the per-point perimeter contribution
$m_i\,q_i$; subsampled outward-normal arrows; bottom-left of each 2×2
panel is the volume conservation diagnostic.
...
<tr>
<td><img src="results/two_ellipses.gif" alt="Two ellipses merging" width="100%"></td>
<td><img src="results/flower.gif" alt="Flower rounding" width="100%"></td>
</tr>
</table>

Full-quality `.mp4` versions of both showcases live next to the gifs at
[`results/two_ellipses.mp4`](results/two_ellipses.mp4) and
[`results/flower.mp4`](results/flower.mp4).

Static counterparts (for the paper PDF):
[`results/two_ellipses_evolution.{png,pdf}`](results/two_ellipses_evolution.png),
[`results/flower_evolution.{png,pdf}`](results/flower_evolution.png).
