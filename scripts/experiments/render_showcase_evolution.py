...
from ablation_summary import (
    SNAPSHOT_STEPS, _save_png_pdf, _draw_normal_arrows,   # noqa: E402, F401
)
...
def main():
    ...
    for step, alpha in zip(SNAPSHOT_STEPS, SNAPSHOT_ALPHAS):
        ...
        # Outward-normal arrows (kept faint so the time-coded scatter
        # remains the primary signal; matches the ablation snapshot grid).
        _draw_normal_arrows(ax, pos, angles_arr[idx], xlim, ylim,
                            num_arrows=28)
